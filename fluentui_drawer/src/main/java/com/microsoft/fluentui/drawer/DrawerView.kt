...
internal class DrawerView(context: Context, attrs: AttributeSet) : LinearLayoutCompat(context, attrs) {
    ...
    init {
        ...
        cornerRadius = drawerTypedArray.getDimension(R.styleable.FluentUIDrawerView_fluentuiDrawerView_cornerRadius, resources.getDimension(R.dimen.fluentui_drawer_corner_radius))
